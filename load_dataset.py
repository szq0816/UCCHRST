...
def load_dataset(dataset, batch_size):
    ...
    '''
    train_loc = '/mnt/37ac491f-6b14-4a78-83b3-1985fda35bb2/zj/new/code/datasets/UCMFH_clip/UCMFH_clip/'+dataset+'/train.pkl'
    query_loc = '/mnt/37ac491f-6b14-4a78-83b3-1985fda35bb2/zj/new/code/datasets/UCMFH_clip/UCMFH_clip/'+dataset+'/query.pkl'
    retrieval_loc = '/mnt/37ac491f-6b14-4a78-83b3-1985fda35bb2/zj/new/code/datasets/UCMFH_clip/UCMFH_clip/'+dataset+'/retrieval.pkl'
